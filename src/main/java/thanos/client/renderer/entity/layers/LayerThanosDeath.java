package thanos.client.renderer.entity.layers;
...
public class LayerThanosDeath implements LayerRenderer<EntityThanos> {
	@Override
	public void doRenderLayer(EntityThanos entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
